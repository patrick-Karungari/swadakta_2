    <!-- tinyslider -->
    <link rel="stylesheet" href="<?php echo base_url('assets/layouts/css/tiny-slider.css') ?>">

    <!-- css -->
    <link href="  <?php echo base_url('assets/layouts/css/bootstrap.min.css') ?> " rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url('assets/layouts/css/materialdesignicons.min.css') ?>
" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url('assets/layouts/css/style.css') ?>
" rel="stylesheet" type="text/css" />
    <!-- CONTACT US START -->
    ...
    <!-- FOOTER ALT END -->
    <script src="<?php echo base_url('assets/layouts/js/bootstrap.bundle.min.js') ?>
"></script>
    <script src="<?php echo base_url('assets/layouts/js/smooth-scroll.polyfills.min.js') ?>
"></script>
    <script src="<?php echo base_url('assets/layouts/js/gumshoe.polyfills.min.js') ?>
"></script>
    <script src="<?php echo base_url('assets/layouts/js/tiny-slider.js') ?>
"></script>
    <!--Particles JS-->
    <script src="<?php echo base_url('assets/layouts/js/particles.js') ?>
"></script>
    <script src="<?php echo base_url('assets/layouts/js/particles.app.js') ?>
"></script>
    <!-- Main Js -->
    <script src="<?php echo base_url('assets/layouts/js/app.js') ?>
"></script>
